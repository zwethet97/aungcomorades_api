...
{   
    ...
    {   
        ...
        return view('admin.reward.threed',[
                'rewards' => $rewards,
                'referrals' => $referrals,
                'start' => $start,
                'end' => $end
