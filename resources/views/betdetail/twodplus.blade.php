              ...
              <div class="card bg-light d-flex flex-fill">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                         <h6 style="text-align:right"> {{ $NoonSlipAmount * 0.10 }} </h6>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-6">
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <form action="{{ route('bet.twodplus') }}" method="POST">
                      @csrf
                      @method('POST')
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                         <h6 style="text-align:right"> {{ $EvenSlipAmount * 0.10 }} </h6>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-6">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                         <h6 style="text-align:right"> {{ $tmrNoonSlipAmount * 0.10 }} </h6>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                         <h6 style="text-align:right"> {{ $tmrNoonSlipAmount * 0.90 }} </h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                         <h6 style="text-align:right"> {{ $tmrEvenSlipAmount * 0.10 }} </h6>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                         <h6 style="text-align:right"> {{ $tmrEvenSlipAmount * 0.90 }} </h6>
                        </div>
                      </div>
                    </div>
