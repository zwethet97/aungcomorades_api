...
<meta charset="utf-8">
  ...
  <title>Aung Pwal | Internet</title>
          ...
          <div class="row">
            <div class="col-12 col-sm-6 col-md-6 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <span class="badge bg-secondary bg-success">9:30</span>
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <form action="{{ route('bet.internet') }}" method="POST">
                      @csrf
                      @method('POST')
                    <input type="text" name="date" value="{{ $date }}" style="display:none"/>
                    <input type="text" name="time" value="09:30 AM" style="display:none"/>
            ...
            <div class="col-12 col-sm-6 col-md-6 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                <div class="card-header text-muted border-bottom-0">
                <span class="badge bg-secondary">{{ $date }}</span>
                <span class="badge bg-secondary bg-success">2:00</span>
                ...
                <div class="card-footer">
                  ...
                  <form action="{{ route('bet.internet') }}" method="POST">
                    ...
                    <input type="text" id="time" name="time" value="2:00 PM" style="display:none"/>
                    <button type="submit" class="btn btn-sm btn-primary">
                      <i class="fas fa-user"></i> View Details
                    </button>
                    </form>
              ...
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-footer">
                  ...
                  <form action="{{ route('bet.internet') }}" method="POST">
                      ...
                      @method('POST')
                    <input type="text" name="date" value="{{ $tdate }}" style="display:none"/>
                    <input type="text" name="time" value="2:00 PM" style="display:none"/>
                    <button type="submit" class="btn btn-sm btn-primary">
                      <i class="fas fa-user"></i> View Details
                    </button>
                    </form>
