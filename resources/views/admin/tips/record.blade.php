  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create Tip Record</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('tips.record.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
      <div class="modal-body">
          ...
          <div class="form-group">
                        ...
                        <select name="time">
                          ...
                          <option value="4:31 PM">4:31 PM</option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label>Result</label>
        ...
        <div class="form-group">
            <label for="tipnumber" class="col-form-label">Tip Number</label>
            <input type="text" class="form-control" id="tipnumber" name="tipnumber">
          </div>
          <div class="form-group">
                ...
                <table class="table table-hover text-nowrap" id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $tip['twod'] }}</td>
                      <td>{{ $tip['result'] }}</td>
                      <td><a href="" data-toggle="modal" data-target="#one{{ $tip->id }}">Banner Image One</a>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <img src="{{ url('/tipBanner/'.$tip['banner_one']) }}" width="100%"/>
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    </div>
    ...
    overflow: auto;">{{ $tip['description_one'] }}</td>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <img src="{{ url('/tipBanner/'.$tip['banner_two']) }}" width="100%"/>
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    </div>
                      ...
                      <td style="max-width: 200px;
    overflow: auto;">{{ $tip['description_two'] }}</td>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <img src="{{ url('/tipBanner/'.$tip['banner_three']) }}" width="100%"/>
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    </div>
                      ...
                      <td style="max-width: 200px;
    overflow: auto;">{{ $tip['description_three'] }}</td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
