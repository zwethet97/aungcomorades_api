  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Internet Compensation</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('compensate.internet') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
...
@endif
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card-header">
                <h3 class="card-title">9:30 AM Compensation</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-hover text-nowrap" id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $winslip['betinteger']['amount'] * 80 }}</td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
            <div class="card-header">
                <h3 class="card-title">2:00 PM Compensation</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $winslipEven['betinteger']['amount'] * 80 }}</td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
